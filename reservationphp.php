...
$sql = "INSERT INTO clients (ReservationID, ClientID,ClientName,PhoneNumber,ClientEmail,ReservationType,Date)
VALUES ('$ReservationID', '$ClientID','$ClientName','$PhoneNumber','$ClientEmail','$ReservationType','$Date')";
...
<span style = "color:white;position:absolute;left:765px;top:9px;font-size:15px;">Almaty city,Pushkin street 41 </span>
<span style = "color:white;position:absolute;left:765px;top:31px;font-size:15px;">1-st floor,salon"JAMILA" </span>
...
<h2 style ="font-family:arial;color:gold;position:absolute;top:53px;right:510px;" >Salon of beauty<h2>
<p></p>
<ul>
...
maxlength="30" placeholder = "Come up with the ID of your reservation..." id = "reservationid" />
 <input type="text" name="ClientID" size="35" style="padding:10px;position:absolute;top:420px;left:580px;"
maxlength="30" placeholder = "Come up with your unique ID..." id = "clientid"/>
...
maxlength="30" placeholder = "Your email...." id = "email"/>
