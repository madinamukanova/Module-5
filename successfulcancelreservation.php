...
<html>
<head>
<title>Want to cancel your reservation?</title>
<style>
body {
...
<form action = "cancelreservationphp.php" method = "POST">
<p style = "text-align:left;color:#E58E0C;;font-size:40px;position:absolute;top:270px;left:510px;">Cancel A Reservation</p>
<p style = "text-align:left;color:blue;font-size:20px;position:absolute;top:340px;left:490px;">You have successfully cancelled your reservation. </p>
<p style = "text-align:left;color:black;font-size:20px;position:absolute;top:360px;left:490px;">If you want to cancel your reservation, </p>
<p style = "text-align:left;color:black;font-size:20px;position:absolute;top:380px;left:490px;">you need to type in the ID of your reservation.</p>
<input type="text" name="ReservationID" size="35" id = "ID" style="padding:10px;position:absolute;top:430px;left:520px;"
maxlength="30" placeholder = "Enter the ID of your reservation..." pattern="[0-9]+" title="Please enter digits only" required/>


<input type = "submit" name = "submit" value = "Enter" style = "background-color:red;color:white;height: 50px;margin:15px;font-family:sans serif;font-size:30px;position:absolute; right:510px;top:470px;" onclick = "MyFunction1()">
...
alert("Check your email. You will receive a letter. Follow the instructions.");
