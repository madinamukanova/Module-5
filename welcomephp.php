...
$WorkerPassword = md5($WorkerPassword);
...
<span style = "color:white;position:absolute;left:385px;top:17px;font-size:20px;">beautysalon.jamila@gmail.com</span>
<img src = "address.png" style = "position:absolute;left:760px" width = "40px" />
<span style = "color:white;position:absolute;left:795px;top:9px;font-size:15px;">Almaty city,Pushkin street 41 </span>
<span style = "color:white;position:absolute;left:795px;top:31px;font-size:15px;">1-st floor,salon"JAMILA" </span>
...
<h2 style ="font-family:arial;color:gold;position:absolute;top:16px;right:570px;" >Salon of beauty<h2>
<p></p>
<ul>
  <li><a href="homepage.html" style="text-decoration:none;font-size:25px;background-color:black;color:white;">Homepage</a></li>
  <li><a href="services.html" style="text-decoration:none;position:absolute;right:950px;">Our services</a></li>
  <li><a href="news.html" style="text-decoration:none;position:absolute;right:780px;">News</a></li>
...
<p style = "text-align:left;color:black;font-size:40px;position:absolute;top:240px;left:50px;">Welcome <?php echo $_SESSION['WorkerName']; ?></p>
</body>
</html>
<script>
function MyFunction(){
